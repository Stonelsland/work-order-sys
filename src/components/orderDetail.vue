   ...
   <div class="ivu-modal">
      <div class="ivu-modal-content">
            ...
            <div class="message1">
               ...
               <div class="message2"><span>
                  ...
                  <Select v-model="approver" disabled v-if="editState">
                     <Option v-for="item in approverList" :value="item.value" :key="item.value">{{ item.label }}
                     </Option>
                  </Select>
               ...
               <div class="message2"><span>
                  ...
                  <Select v-model="business" disabled v-if="editState">
                     <Option v-for="item in businessList" :value="item.value" :key="item.value">{{ item.label }}
                     </Option>
                  </Select>
            ...
            <div class="message1">
               <div class="message2"><span>
                  ...
                  <Select v-model="host" disabled v-if="editState">
                     <Option v-for="item in hostList" :value="item.value" :key="item.value">{{ item.label }}
                     </Option>
                  </Select>
               ...
               <div class="message2"><span>
                  ...
                  <Select v-model="state" disabled >
                     <Option v-for="item in stateList" :value="item.value" :key="item.value">{{ item.label }}
                     </Option>
                  </Select>
               </div>
               <div class="message2"><span>
         ...
         <div class="ivu-modal-footer">
            <div class="submit">
               <button type="button" @click="openEdit" v-if="state==`未提交`"
                       class="ivu-btn ivu-btn-primary"
               ><span>编辑</span></button>
               <button type="button" @click="commitOrder(
                                                      title,
                                                      approver,
                                                      business,
                                                      host,
                       ...
                       class="ivu-btn ivu-btn-primary" v-if="state==`未提交`"
               ><span>提交</span></button>
               <button type="button" v-if="editState" @click="back"
                       class="ivu-btn ivu-btn-default"
               ><span>返回</span></button>
               <button type="button" v-else @click="saveEdit(
                                                      title,
                                                      approver,
                                                      business,
                                                      host,
...
<script>
   ...
   export default {
      ...
      methods: {
         ...
         //编辑后保存
         saveEdit(title, approver, business, host, state, content, creator, time, index) {
            var edited = {
               title,
               approver,
               business,
         ...
         //提交工单审批
         commitOrder(title, approver, business, host, state, content, creator, time) {
            var commit = {
               title,
               approver,
               business,
